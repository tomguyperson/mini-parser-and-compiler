    ...
    while(pc != NULL)
    {
        ...
        switch(pc->type)
        {
            case NOOP:
                ...
                break;
            case IN:
                // cout << "inpytting to " << pc->input_inst.var_index << endl;
                mem[pc->input_inst.var_index] = inputs[next_input];
                // cout << mem[pc->input_inst.var_index] <<endl;
                
                next_input++;
                pc = pc->next;
                break;
            case OUT:
                // cout << "printing val at  " << pc->output_inst.var_index << endl;
                printf("%d ", mem[pc->output_inst.var_index]);
                pc = pc->next;
                break;
            case ASSIGN:
                // cout << "assign deez nuts" << endl;
            ...
            case CJMP:
                ...
                // cout << "condition " << op1 << " " << pc->cjmp_inst.condition_op << " " << op2 << endl; 
